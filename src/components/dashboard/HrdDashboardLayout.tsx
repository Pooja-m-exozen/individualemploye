...
import { FaTachometerAlt, FaUsers, FaTasks,  FaSun, FaMoon, FaBars, FaSignOutAlt, FaChevronRight, FaIdCard, FaTshirt, FaCalendarAlt, FaPlaneDeparture, FaProjectDiagram, FaIdBadge } from "react-icons/fa";
import { useTheme } from "@/context/ThemeContext";
import { getEmployeeId, logout } from "@/services/auth";
import Link from "next/link";

interface HrdDashboardLayoutProps {
  children: React.ReactNode;
}

const menuItems = [
  { label: "Dashboard", icon: <FaTachometerAlt />, href: "/hrd/dashboard" },
  {
    label: "Recruitment & Onboarding",
    icon: <FaUsers />,
    subItems: [
      { label: "Create", href: "/hrd/recruitment-onboarding/create" },
      { label: "View", href: "/hrd/recruitment-onboarding/view" },
    ]
  },
  { label: "Project Management", icon: <FaProjectDiagram />, href: "/hrd/project-management" },
  { label: "Employee Management", icon: <FaUsers />, href: "/hrd/employee-management" },
  {
    label: "KYC Management",
    icon: <FaIdBadge />,
    subItems: [
      { label: "Create KYC", href: "/hrd/kyc-management/create" },
      { label: "View KYC", href: "/hrd/kyc-management/view" },
    ]
  },
  {
    ...
    icon: <FaIdCard />,
    subItems: [
      { label: "View", href: "/hrd/id-card-management/view" },
    ]
  },
  {
    ...
    icon: <FaTshirt />,
    subItems: [
      { label: "Requests", href: "/hrd/uniform-management/requests" },
      { label: "View", href: "/hrd/uniform-management/view" }
    ]
  },
  {
    ...
    icon: <FaCalendarAlt />,
    subItems: [
      { label: "View", href: "/hrd/attendance-management/view" },
  ...
  },
  {
    ...
    subItems: [
      { label: "View", href: "/hrd/leave-management/view" },
    ]
  },
  {
    ...
    icon: <FaSignOutAlt />,
    subItems: [
      { label: "Update Employee", href: "/hrd/exit-offboarding/update" },
      { label: "View", href: "/hrd/exit-offboarding/view" },
    ]
  },
  {
  ...
  },
  {
    ...
    subItems: [
      ...
      { label: "Project", href: "/hrd/reports/project" },
      { label: "Employee", href: "/hrd/reports/employee" },
      { label: "KYC", href: "/hrd/reports/kyc" },
      { label: "ID Card", href: "/hrd/reports/id-card" },
      { label: "Uniform", href: "/hrd/reports/uniform" },
      { label: "Attendance", href: "/hrd/reports/attendance" },
      { label: "Leave", href: "/hrd/reports/leave" },
    ]
  },

];

const HrdDashboardLayout = ({ children }: HrdDashboardLayoutProps) => {
        ...
        <header className={`${theme === "dark" ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border-b shadow-lg sticky top-0 h-[64px] flex items-center px-4 transition-colors duration-200`}>
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className={`text-xl font-bold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Hrd Dashboard</h1>
            </div>
...
export default HrdDashboardLayout;
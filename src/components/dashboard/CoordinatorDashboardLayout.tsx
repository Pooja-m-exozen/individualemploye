...
const CoordinatorDashboardLayout = ({ children }: CoordinatorDashboardLayoutProps): React.ReactNode => {
  ...
  const topNav: Array<{ label: string; href?: string; subItems?: Array<{ label: string; href: string }>; }> = useMemo(() => [
    ...
    { label: "Attendance", href: "/coordinator/attendance-management" },
    { label: "KYC", href: "/coordinator/kyc-management/view" },
    { label: "ID Card", href: "/coordinator/id-card-management" },
    { label: "Stores", href: "/coordinator/stores-management/in-stock" },
    { label: "Uniform", href: "/coordinator/uniform-management/requests" },
    { label: "DC", href: "/coordinator/stores-management/dc" },
    { label: "Reports", href: "/coordinator/reports/employee" },
  ], []);
      ...
      <header className={`${theme === "dark" ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border-b shadow-lg sticky top-0 left-0 w-screen z-50 h-[64px] flex items-center px-4 transition-colors duration-200`}>
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className={`text-xl font-bold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Coordinator</h1>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Date and Time */}
            <div className={`font-medium text-sm px-4 py-1.5 rounded-full border ${
              theme === "dark"

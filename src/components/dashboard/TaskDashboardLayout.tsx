...
const TaskDashboardLayout = ({ children }: TaskDashboardLayoutProps): React.ReactNode => {
              ...
              <div className="flex items-center relative">
                ...
                {showProfileDropdown && (
                  ...
                  >
                    ...
                    >
                      <FaUser className="text-orange-500 w-5 h-5" /> Task View
                    </button>
                    <button

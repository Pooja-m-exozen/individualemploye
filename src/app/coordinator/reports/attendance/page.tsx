...
import CoordinatorOpsLayout from "@/components/dashboard/CoordinatorDashboardLayout";
...
const OverallAttendancePage = (): JSX.Element => {
  ...
  const handleTabClick = (tab: 'overall' | 'consolidated') => {
    setActiveTab(tab);
    if (tab === 'overall') {
      router.push('/coordinator/reports/attendance');
    } else if (tab === 'consolidated') {
      router.push('/coordinator/reports/attendance/overall');
    }
  };

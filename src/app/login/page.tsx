...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[url('/bg.png')] bg-cover bg-center bg-no-repeat px-4 py-12">
      <Toaster 
        toastOptions={{
          className: '',
          style: {
      ...
      <motion.div 
        ...
        className="max-w-md w-full bg-white/95 backdrop-blur-sm rounded-2xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] p-10"
      >
        ...
        <h2 className="text-center text-3xl font-bold text-gray-800 mb-2 bg-gradient-to-r from-indigo-600 to-blue-500 bg-clip-text">
          Welcome Back
        </h2>

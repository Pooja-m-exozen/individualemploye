        ...
        <aside className={`w-72 p-6 flex flex-col gap-4 ${
          ...
          <div className={`rounded-lg border flex items-start gap-3 p-4 hover:bg-gray-50 transition-colors cursor-pointer ${
            ...
            <div>
              ...
              }`}>Submit a leave request for approval.</div>
            </div>
          </div>
          ...
          <div className={`rounded-lg border flex items-start gap-3 p-4 hover:bg-gray-50 transition-colors cursor-pointer ${
            ...
            <div>
              ...
              <div className={`text-xs ${
                theme === 'dark' ? 'text-gray-300' : 'text-gray-500'
              }`}>Request corrections to your attendance.</div>
            </div>
          </div>
          ...
          <div className={`rounded-lg border flex items-start gap-3 p-4 hover:bg-gray-50 transition-colors cursor-pointer ${
            ...
            <div>
              ...
              <div className={`text-xs ${
                theme === 'dark' ? 'text-gray-300' : 'text-gray-500'
              }`}>Upload important documents securely.</div>
            </div>
          </div>
          ...
          <div className={`rounded-lg border flex items-start gap-3 p-4 hover:bg-gray-50 transition-colors cursor-pointer ${
            ...
            <div>
              ...
              <div className={`text-xs ${
                theme === 'dark' ? 'text-gray-300' : 'text-gray-500'
              }`}>Report an issue or request support.</div>
            </div>
          </div>
        </aside>

      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 flex flex-col py-8">
        ...
        <div className="flex-1 px-6">
          <div className="max-w-7xl mx-auto">
            {/* Toast Notification */}
            {toast && (
              <div className={`fixed top-4 right-4 z-50 px-6 py-4 rounded-xl shadow-2xl text-white text-sm flex items-center gap-3 max-w-md animate-slide-in ${toast.type === "success" ? "bg-emerald-500" : "bg-red-500"}`}>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              {loading ? (
                <div className="flex flex-col justify-center items-center py-16">
                  ...
                  <p className="text-gray-600 font-medium mt-4">Loading KYC records...</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-500 text-sm"
                            />
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
                          ...
                          <div className="text-right">
                            <div className="text-sm text-gray-600">
                              Showing <span className="font-semibold text-gray-900">{filtered.length}</span> of <span className="font-semibold text-gray-900">{kycForms.length}</span> records
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          {[
                            ...
                            <th
                              key={col.title}
                              className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide cursor-pointer hover:bg-blue-50 transition-colors duration-200"
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {paginated.map(form => (
                          <tr key={form._id} className="hover:bg-blue-50 transition-all duration-200 group">
                            {/* Employee Cell */}
                                ...
                                <div className="relative">
                                  {form.personalDetails.employeeImage ? (
                                    <img
                                      ...
                                      className="w-12 h-12 rounded-full object-cover border-2 border-gray-200 shadow-sm group-hover:border-blue-300 transition-colors duration-200"
                                    />
                                  ) : (
                                    <div className="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center border-2 border-gray-300 shadow-sm group-hover:border-blue-300">
                            ...
                            {/* Designation Cell */}
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-700 font-medium">{form.personalDetails.designation}</div>
                            </td>
                            {/* Project Cell */}
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-700 font-medium">{form.personalDetails.projectName}</div>
                            </td>
                            {/* Status Cell */}
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border transition-all duration-200 ${getStatusColor(form.status)}`}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center gap-2">
                                <button
                                  ...
                                  className="flex items-center gap-1 px-3 py-2 rounded-lg bg-blue-100 text-blue-700 text-xs font-medium hover:bg-blue-200 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-105"
                                  title="Edit KYC"
                                >
                                ...
                                <button
                                  ...
                                  className="flex items-center gap-1 px-3 py-2 rounded-lg bg-gray-100 text-gray-700 text-xs font-medium hover:bg-gray-200 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-105"
                                  title="View Details"
                                >
                                ...
                                <button
                                  ...
                                  className="flex items-center gap-1 px-3 py-2 rounded-lg bg-red-100 text-red-700 text-xs font-medium hover:bg-red-200 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-105"
                                  title="Delete KYC"
                                >

...
export default function AttendanceReportPage() {
  ...
  return (
    <div
      className={`min-h-screen font-sans ${theme === "dark"
              ...
              <td className="px-3 py-2 w-1/6" rowSpan={2}>
                <div className={`p-2 ${theme === "dark" ? "bg-gray-800" : "bg-blue-50"}`}>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={theme === "dark" ? "text-gray-200" : "text-blue-700"}>Attendance Regularization</span>
                  </div>
                </div>
              </td>
              <td className="px-3 py-2 w-5/6">
                <div className={`p-4 ${theme === "dark" ? "bg-gray-900" : "bg-white"}`}>
                  <p className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>Manage and regularize employee attendance records, including correction of missed punches and shift adjustments.</p>
                </div>
              </td>
            </tr>
                        ...
                        filteredRecords.map((rec, idx) => (
                          ...
                          >
                            ...
                            <td className={`px-4 py-3 ${theme === "dark" ? "text-white" : "text-black"}`}>
                              <span className={`inline-block px-2 py-1 rounded-full text-xs font-semibold ${rec.status === "Present"
                            ...
                            <td className={`px-4 py-3 ${theme === "dark" ? "text-white" : "text-black"}`}>
                              <span className={`inline-block px-2 py-1 rounded-full text-xs font-semibold ${rec.regularizationStatus === "Approved"
                                ? "bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300"

                                        ...
                                        onClick={() => {
                                          ...
                                          if (isAlreadySelected) {
                                            ...
                                            setSelectedUniforms(prev => {
                                              const newState = prev.filter(u => u.type !== option.type);
                                              console.log('selectedUniforms after removal:', newState);
                                              return newState;
                                            });
                                            ...
                                            setSelectedUniforms(prev => {
                                              ...
                                              console.log('selectedUniforms after addition:', newState);
                                              return newState;
                                            });
                                          ...
                                          // Debug log
                                          console.log('selectedUniforms updated:', selectedUniforms);
                                        }}
                                        title={
                                          selectedUniforms.some(u => u.type === option.type)
